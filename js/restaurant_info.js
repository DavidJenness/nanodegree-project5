...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  image.alt = DBHelper.atTextForRestaurant(restaurant);
  image.title = DBHelper.atTextForRestaurant(restaurant);
...
createReviewHTML = (review) => {
  ...
  name.innerHTML = review.name + ' on ' + review.date;
  name.className ='reviewName';
  name.tabIndex = '0';
  name.setAttribute("aria-label","Name and Date of Review");
  li.appendChild(name);
